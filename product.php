...
<body>
    ...
    <h2 style="margin-top: 100px;" class="text-center">Tenda Pernikahan</h2>
    <!-- section galeri -->
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="92%" src="./assets/galeri-1.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-tenda.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
                </div>
            </div>
            <div class="col-md-6 text-center">
             <img class="img-fluid mt-5" width="89.5%" src="./assets/galeri-2.png" alt="icon rental" srcset="">
             <div class="text-center mt-3">
                    <a href="product-tenda.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="92%" src="./assets/galeri-3.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-tenda.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
            ...
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="89.5%" src="./assets/galeri-4.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-tenda.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
    ...
    <h2 style="margin-top: 100px;" class="text-center">Alat Pesta</h2>
    <!-- section galeri -->
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="92%" src="./assets/blower.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-alat.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
                </div>
            </div>
            <div class="col-md-6 text-center">
             <img class="img-fluid mt-5" width="88%" src="./assets/meja.png" alt="icon rental" srcset="">
             <div class="text-center mt-3">
                    <a href="product-alat.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="92%" src="./assets/sendok.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-alat.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
            ...
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="90%" src="./assets/meja2.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-alat.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
    ...
    <h2 style="margin-top: 100px;" class="text-center">Organ Tunggal</h2>
    <!-- section galeri -->
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="92%" src="./assets/organ 1.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-organ.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
                </div>
            </div>
            <div class="col-md-6 text-center">
             <img class="img-fluid mt-5" width="90%" src="./assets/organ 2.png" alt="icon rental" srcset="">
             <div class="text-center mt-3">
                    <a href="product-organ.php">
                        <button class="btn-lihat">LIHAT DETAIL</button>
                    </a>
    ...
    <h2 style="margin-top: 100px;" class="text-center">Paket Pernikahan</h2>
    <!-- section galeri -->
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <img class="img-fluid mt-5" width="92%" src="./assets/paket 1.png" alt="icon rental" srcset="">
                <div class="text-center mt-3">
                    <a href="product-paket.php">
                        <button class="btn-lihat">PAKET 1</button>
                    </a>
                </div>
            </div>
            <div class="col-md-6 text-center">
             <img class="img-fluid mt-5" width="90%" src="./assets/paket 2.png" alt="icon rental" srcset="">
             <div class="text-center mt-3">
                    <a href="product-paket.php">
                        <button class="btn-lihat">PAKET 2</button>
                    </a>
                </div>
            </div>
        </div>

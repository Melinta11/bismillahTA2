...
<body>
    ...
    <section class="hubungi">
        <div class="container">
            ...
            <h1 class="text-center">Tenda VIP Putih Oren</h1>
            <div style="margin-top: 20px"></div>
            <h5 class="text-center">Harga mulai dari Rp. 500.000/m2</h5>
            <div class="row">
                <div class="col-md-12 text-center">
                <img class="img-center mt-3" width="60%" src="./assets/galeri-1.png" alt="icon rental" srcset="">
                </div>
            </div>
            ...
            <table class="table table-striped mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Kokoh, Tidak panas, Mengkilat dan Halus</td>
                    </tr>
                </tbody>
            </table>
        ...
        function showAlert() {
            ...
            Swal.fire(
                ...
                if (result.isConfirmed) {
                    window.location.href = 'product-tenda.php';
                }
            })
        }

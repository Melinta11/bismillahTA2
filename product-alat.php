...
<body>
    ...
    <section class="hubungi">
        <div class="container">
            ...
            <h1 class="text-center">Kipas Embun</h1>
            <div style="margin-top: 20px"></div>
            <h5 class="text-center">Rp. 200.000/hari</h5>
            <div class="row">
                <div style="margin-top: 20px"></div>
                <div class="col-md-12 text-center">
                <img class="img-center mt-3" width="60%" src="./assets/blower.png" alt="icon rental" srcset="">
                </div>
            </div>
            ...
            <table class="table table-striped mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>30 inch, Tabung air 60 liter</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Aman dari konslet, tahan panas</td>
                    </tr>                                       
                </tbody>
            </table>
        ...
        function showAlert() {
            ...
            Swal.fire(
                ...
                if (result.isConfirmed) {
                    window.location.href = 'product-alat.php';
                }
            })
        }

...
<?php 
    ...
    $qry = mysqli_query($conn, "SELECT * FROM users WHERE name='{$_SESSION['name']}'");
...
<body>
    ...
    <section class="hubungi">
        <h2 class="text-center">Riwayat Pesanan Anda</h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table table-striped mt-2">
                        ...
                        <tbody>
                            <tr>
                                <th class="align-middle">ORDER-2381473232</th class="align-middle">
                                <td class="align-middle">Melinta Nurul Islam</td>
                                <td class="align-middle">Kipas Embun</td>
                                <td class="align-middle">2</td>
                                <td class="align-middle">Desa Purwanegara, Purwokerto</td>
                                <td class="align-middle"><button class="btn btn-primary">Delivered</button></td>
                                <td class="align-middle"><a href="">Lihat Detail</a></td>
                            </tr>
                            <tr>
                                <th class="align-middle">ORDER-442323232</th class="align-middle">
                                <td class="align-middle">Melinta Nurul Islam</td>
                                <td class="align-middle">Paket Organ Tunggal</td>
                                <td class="align-middle">1</td>
                                <td class="align-middle">Desa Purwanegara, Purwokerto</td>
                                <td class="align-middle"><button class="btn btn-secondary">Pending</button></td>
                                <td class="align-middle"><a href="">Lihat Detail</a></td>
                            </tr>
                        </tbody>
                    </table>

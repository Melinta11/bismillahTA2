...
<body>
    ...
    <section class="hubungi">
        <div class="container">
            ...
            <h1 class="text-center">Paket Pernikahan Full Set</h1>
            <div style="margin-top: 20px"></div>
            <h5 class="text-center">Rp. 10.000.000</h5>
            <div class="row">
                <div class="col-md-12 text-center">
                <img class="img-center mt-3" width="60%" src="./assets/paket 1.png" alt="icon rental" srcset="">
                </div>
            </div>
            ...
            <table class="table table-striped mt-5">
                ...
                <tbody>
                    <tr>
                        <th scope="row">Tenda dekorasi</th>
                        <td>80 meter/2</td>
                    </tr>
                    <tr>
                        <th scope="row">Pelaminan megah</th>
                        <td>9 meter</td>
                    </tr>
                    <tr>
                        <th scope="row">Panggung pelaminan tinggi</th>
                        <td>30 cm/ 50 cm</td>
                    </tr>                                      
                    <tr>
                        <th scope="row">Alat masak</th>
                        <td>kompor 2 unit</td>
                    </tr>  
                    <tr>
                        <th scope="row">Alat masak</th>
                    ...
                    <tr>
                        ...
                        <td>futura+cover 80 unit</td>
                    </tr>  
                    <tr>
                        <th scope="row">Meja</th>
                        <td>meja+gubukan 2 unit</td>
                    </tr>                    <tr>
                        <th scope="row">Meja</th>
                        <td>meja penerima tamu 1 unit</td>
                    </tr>                    <tr>
                        <th scope="row">Alat prasmanan</th>
                        <td>6 unit</td>
                    </tr>                    <tr>
                        <th scope="row">Kipas embun</th>
                        <td>2 unit</td>
                    </tr>                    
                </tbody>
            </table>
        ...
        function showAlert() {
            ...
            Swal.fire(
                ...
                if (result.isConfirmed) {
                    window.location.href = 'product-paket.php';
                }
            })
        }
